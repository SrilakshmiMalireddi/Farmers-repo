		...
		<div class="container">
			...
			<nav>
			  <ul>
				...
				<li class="current"><a href="Viewtest.php">View</a></li>
				<li><a href="Signintest.php">Sign In</a></li>
			  </ul>
			</nav>
		</div>
	</header>
	...
	<section>
		<div class="container">
				...
				<form method=POST action="<?php echo $_SERVER["PHP_SELF"];?>"> 
						...
						<span id="dropdown-head">&nbsp&nbsp FILE FORMAT:</span>
						...
						<span id="dropdown-head">&nbsp&nbsp&nbsp TYPE OF DOCUMENT:</span>
						...
						<span>&nbsp&nbsp&nbsp PUBLICATION NAME:</span>
						<select name="source">
							<?php
							for($j = 0; $j < $l; $j++)
							{
						...
						<span>&nbsp&nbsp&nbsp LANGUAGE:</span>
						<select name="lang">
							<?php
							for($j = 0; $j < $p; $j++)
							{
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~WHEN A PARTIULAR TYPE OF FILE AND A PARTICULAR TYPE OF DOC ARE SELECTED ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
			if($fileformat != 6 && $documenttype != 3)
			{
				...
				{		
					...
					else if($source == 1 && $language == 0) //if only a particular language is selected
					{
			...
			} //only a signle type of file and single type of doc
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ WHEN ONLY A PARTICULAR FILE IS SELECTED ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
			else if($fileformat != 6 && $documenttype == 3)
			{
				...
				else if(strcmp($_POST['date'], "single") == 0) //when only a single date is selected
				{
